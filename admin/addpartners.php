 ...
 <script type="text/javascript" >
	$(function(){
		...
		new AjaxUpload(btnUpload, {
			...
			onComplete: function(file, response){
				...
				//alert(response);
				if(response==="success"){
					$('#files').html('<img src="../images/partnersimg/'+file+'" alt="" />').addClass('success');
    ...
    <?php include ("inc/header.php"); ?>
        ...
        <div class="dil_pagewrp_product"><div class="dil_product_wrapper">
         ...
         <div class="dil_prodcuttitle">Add Partners</div>
        ...
        <div class="dil_prodcutinput"><textarea name="prddescription" id="prddescription" class="catinputclasstextarea"></textarea></div><br class="clear"/>
             <div class="dil_prodcutlable">Partner's Image :</div>
        ...
        <div class="dil_prodcuttitle">View Partners</div>
        <br class="clear"/><br class="clear"/>
        <div class="filterdiv">
        <div class="filetrby">Search By Partner's Name :-</div>
