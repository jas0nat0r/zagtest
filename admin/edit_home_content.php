...
if ($p_id != '') {
    ...
    $sqls = "select * from " . $tblSlider . " WHERE id=" . tosql($p_id, "Number");
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                ...
                                                <table  border="0" width="100%">
                                                    ...
                                                    <tr>
                                                        <td colspan="2" class="heading">Edit Slider image details</td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" valign="top" class="Normal">
                                                            ...
                                                            <a id="upload_link" class="links" href="#">Click here to upload a new Slider image</a>
                                                ...
                                                <div id="save_form">
                                                    <form action="" method="post">
                                                        <table  border="0" width="100%">                                                        
                                                            ...
                                                            <tr>
                                                                <td valign="top" class="NormalDisabled" width="150">Banner Title</td>
                                                                <td align="left" valign="top" class="Normal"><input type="text" name="title" value="<?= $rows['title']; ?>"/></td>
                                                            </tr>
                                                            <tr>
                                                                <td valign="top" class="NormalDisabled" width="150">Description</td>
                                                                <td align="left" valign="top" class="Normal"><input type="text" name="description" value="<?= $rows['description']; ?>"/></td>
                                                            </tr>
