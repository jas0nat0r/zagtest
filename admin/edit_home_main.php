...
switch ($Submit) {
    ...
    case "Add":
        ...
        $sql = "INSERT INTO " . $tblFeatured . "(image,title,large_image) VALUES (\"" .
                $img_order . "\"," .
				"\"" . $_REQUEST['title'] . "\"," .
                "\"" . $img_large . "\")";
...
$sqlc = "select * from " . $tblGeneralContent . " where section='home'";
            ...
            <tr>
                <td align="center" valign="top"><form method="post" enctype="multipart/form-data" name="form1" id="form1">
                        <table width="95%" border="0">
                            ...
                            <tr>
                                <td colspan="3" class="heading">Home Content</td>
                            </tr>
                            <tr>
                                <td colspan="3"></td>
                            </tr>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                ...
                                                <table  border="0" width="100%">
                                                    ...
                                                    <tr>
                                                        <td colspan="2" class="heading">Add a Featured Project Image</td>
                                                    </tr>
                                                    <tr>
                                ...
                                <td colspan="3">
                                    ...
                                    <form method="post" name="form1" id="form1">
                                        <table width="90%" border="0">
                                            ...
                                            <tr>
                                                <td colspan="2" class="heading">Designer's Philosophy</td>
                                            </tr>
                                        ...
                                        $oFCKeditor->Value = stripslashes($f_content);
                                        $oFCKeditor->Create();
                                        ?></td>
                                            </tr>
                                            <tr>
                                                <td><input type="hidden" name="n_id" value="<?= $rowc['id']; ?>" /></td>
                                                <td align="right"><input type="submit" value="Update" class="btn" name="Submit"/></td>
                                            </tr>
                ...
                <ul id="list">
                                            <?php
                                            $sql = "select * from " . $tblFeatured . " Where status=1 Order by image_order";
                                                    ...
                                                    <div id="<?php echo $autoid ?>" style="width:900px;height:150px;margin:2px; padding:4px; background-color:#ececec;" onMouseOver="changeColor(this.id,'#dbd9d9')" onMouseOut="changeColor(this.id,'#ececec')">
												       ...
												       <div style="width:143px; height:147px; overflow:hidden; float:left; padding:2px; margin-left: -49px;">
                                                        ...
                                                        <div style="width:212px;height:135px;  overflow:hidden;float: right;">
                                                            ...
                                                            <a href="edit_home_main.php?action=d&id=<?= $row['id']; ?>" class="links" onClick="return confirm('Do you really want to delete ?');">Delete</a>
