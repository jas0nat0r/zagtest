...
switch ($_REQUEST['action']) {
    case 'd':
        ...
        $suc_msg = 'Services deleted sucessfully';
...
switch ($Submit) {
        ...
        $sql = "UPDATE " . $tblGeneralContent . " SET  content = \"" . $s_description . "\" WHERE autoid=" . tosql(9, "Number");
    ...
    <body >
        ...
        <table width="990" height="692" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#98B3CE">
            <tr>
                <td align="center" valign="top"><form method="post" enctype="multipart/form-data" name="form1" id="form1">
                        <table width="95%" border="0">
                            ...
                            <tr>
                                <td colspan="3" class="heading">Our Solutions</td>
                            </tr>
                            <tr>
                                <td colspan="3"></td>
                            </tr>
                            ...
                            <tr>
                                <td colspan="3"><table width="100%" border="0">
                                        ...
                                        <tr>
                                            ...
                                            <tr>
                                                <td colspan="2" class="heading">Edit Content</td>
                                            </tr>
                                                    ...
                                                    <textarea class="wymeditor" name="description"><?= stripslashes($c_content) ?></textarea>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="left" valign="top" class="Normal">
                                                                    ...
                                                                    <input type="submit" value="Update" class="btn wymupdate" name="Submit"/>
                                                                </td>
                                                            </tr>
                        ...
                        <form action="" method="post" name="frmfaq">
                            ...
                            <table width="100%" border="0" align="center">
                                ...
                                <tr>
                                    ...
                                    <td  valign="middle" class="SubHead" width="277" ><strong>Services Title</strong></td>
          <td  class="SubHead"><strong>Options</strong></td>
                ...
                <ul id="list">
                                            <?php
                                            $sql = "select * from " . $tblServices . " Where status=1";
                                            ...
                                            while ($row = mysql_fetch_array($rs)) {
                                                ...
                                                <li id="recordsArray_<?php echo $autoid ?>">
                                                    <div id="<?php echo $autoid ?>" style="width:900px;height:150px;margin:2px; padding:4px; background-color:#ececec;" onMouseOver="changeColor(this.id,'#dbd9d9')" onMouseOut="changeColor(this.id,'#ececec')">
												       ...
												       <div style="width:143px; height:147px; overflow:hidden; float:left; padding:2px;">

                                                            <?= $row['title'] ?>

                                                        </div>
                                                       
                                                        <div style="width:212px;height:135px;  overflow:hidden;position: absolute; margin-left: 323px;">
                                                            <a href="edit_services_content.php?id=<?= $row['id'] ?>" class="links">Edit</a> | 


                                                            <a href="edit_services.php?action=d&id=<?= $row['id']; ?>" class="links" onClick="return confirm('Do you really want to delete ?');">Delete</a>
