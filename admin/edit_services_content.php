...
if ($p_id != '') {
    ...
    $sqls = "select * from " . $tblServices . " WHERE id=" . tosql($p_id, "Number");
...
$sqlc = "select * from " . $tblServices . " where id = ".$_GET['id']." and status=1";
...
<!-- WYMeditor main JS file, minified version -->
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                ...
                                                <table  border="0" width="100%">
                                                    ...
                                                    <tr>
                                                        <td colspan="2" class="heading">Edit News details</td>
                                                    </tr>
                                                    <tr>
                                                ...
                                                <div id="save_form">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" valign="top" class="Normal">
                                                            ...
                                                            <br />
                                                            <div id="uploaded_image"><img src="<?= $rows['imagepath']; ?>" alt="Loading..."/></div>
                                                         
                                                        </td>
                                                    </tr>

                                                            <tr>
                                                                <td valign="top" class="NormalDisabled" width="300">Services Title</td>
  ...
  <div id="leftimage_cont">
    <input type="hidden" name="large_image" value="<?= $rows['imagepath']; ?>" />
    <input type="hidden" name="slide_image" value="<?= $rows['imagepath']; ?>" />
</div>
