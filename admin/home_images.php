...
$thumb_width = "901";      // Width of thumbnail image
$thumb_height = "502";
$upload_dir = '../images1/uploads';
...
switch ($Submit) {
    ...
    case "Add Image":
        ...
        $sql = "INSERT INTO " . $tblHomeColumn . "(image,target) VALUES (\"" .
                $_REQUEST['slide_image'] . "\"," .
                "\"" . $_REQUEST['more_link'] . "\")";
        ...
        <script type="text/javascript">
            $(function() {
                ...
                $("#list").sortable({ opacity: 0.6, cursor: 'move',handle : '.handle', update: function() {
                        ...
                        $.post("home_bottom_images_order.php", order, function(theResponse){
                        ...
                        $.ajax({
                            ...
                            success: function(response){
                                ...
                                if(responseType=="success"){
                                    ...
                                    $('#leftimage_cont').html('<input type="hidden" name="slide_image" value="'+responseThumbImage+'" />');
                                    //save_form
            ...
            <tr>
                <td align="center" valign="top"><form method="post" enctype="multipart/form-data" name="form1" id="form1">
                        <table width="95%" border="0">
                            ...
                            <tr>
                                <td colspan="3" class="heading">Home Bottom Images</td>
                            </tr>
                            <tr>
                                <td colspan="3"></td>
                            </tr>
    ...
    echo $suc_msg; ?>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                ...
                                                <table  border="0" width="100%">
                                                    ...
                                                    <tr>
                                                        <td colspan="2" class="heading">Add New Image</td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" valign="top" class="Normal">
                                                            ...
                                                            <a id="upload_link" class="links" href="#">Click here to upload a photo</a>
                                                ...
                                                <div id="save_form" style="display: none;">
                                                    <form action="" method="post">
                                                        <table  border="0" width="100%">                                                        
                                                           ...
                                                           <?php /*?> <tr>
                                                                <td valign="top" class="NormalDisabled">More Link[URL]</td>
                                                                <td align="left" valign="top" class="Normal"><input type="text" name="more_link"/></td>
                                                            </tr><?php */?>
                                                            <tr>
                                                                <td valign="top" class="NormalDisabled"></td>
                                                                <td align="left" valign="top" class="Normal">
                                                                    <div id="leftimage_cont"></div>
                                                                    <input type="submit" value="Add Image" class="btn" name="Submit"/>
                                                                </td>
                                                            </tr>
                        ...
                        <form action="" method="post" name="frmfaq">
                            ...
                            <table width="90%" border="0" align="center">
                                ...
                                <tr>
                                    <td  valign="middle" class="SubHead" width="70">&nbsp;</td>


                                    <td  valign="middle" class="SubHead"><strong>Image</strong></td>
                                    <td  valign="middle" class="SubHead"><strong>Link</strong></td>
                            ...
                            <table width="95%" border="0" align="center">
                                <tr>
                                    <td height="30" valign="middle" class="SubHead">
                                        ...
                                        <ul id="list">
<?php
$sql = "select * from " . $tblHomeColumn . " Where status=1 Order by image_order";
    ...
    ?>
                                                ...
                                                <li id="recordsArray_<?php echo $autoid ?>">
                                                    <div id="<?php echo $autoid ?>" style="width:900px;height:150px;margin:2px; padding:4px; background-color:#ececec;" onMouseOver="changeColor(this.id,'#dbd9d9')" onMouseOut="changeColor(this.id,'#ececec')">
                                                        ...
                                                        <div style="width:200px;height:147px; overflow:hidden; float:left; padding:2px;">

    <?php echo $row['target']; ?>

                                                        </div>
                                                        <div style="width:180px;height:135px;  overflow:hidden;float:left;">
                                                            <!--<a href="edit_news.php?id=<?= $row['id'] ?>" class="links">Edit</a>&nbsp;|&nbsp;-->
                                                            <a href="home_images.php?action=d&id=<?= $row['id']; ?>" class="links" onClick="return confirm('Do you really want to delete ?');">Delete</a>
