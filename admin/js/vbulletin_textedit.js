	...
	*/
	this.init_popup_menu = function(obj)
	{
		...
		switch (obj.cmd)
		{
			case 'fontname':
			{
				var menu = this.init_menu_container('fontname', 'auto', 'auto', 'auto');
		...
		if (is_moz)
		{
			...
			*/
			this.set_editor_functions = function()
			{
				try
				{
					// stop object resizing since we dont support that
					this.editdoc.execCommand('enableObjectResizing', false, false);
				}
				catch (e) {}
...
/*======================================================================*\
|| ####################################################################
|| # Downloaded: 15:00, Thu Apr 20th 2006
|| # CVS: $RCSfile: vbulletin_textedit.js,v $ - $Revision: 1.50.2.3 $
|| ####################################################################
\*======================================================================*/