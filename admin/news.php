...
<!-- WYMeditor main JS file, minified version -->
    ...
    /* Here we replace each element with class 'wymeditor'
            ...
            jQuery(function() {
                jQuery('#catdescription'+catid).wymeditor();
            });
...
wymResults = $('#catdescription11').next().WYMeditor.INSTANCES[0].xhtml();
alert(wymResults);
    ...
    <body  onLoad="dil_filtercategory();">
        ...
        <div class="dil_prodcutinput"><textarea name="catdescription"  class="mainaddform"></textarea></div><br class="clear"/>
