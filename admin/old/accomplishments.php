  ...
  <tr>
    <td width="972" height="415" align="center" valign="top"><form method="post" enctype="multipart/form-data" name="form" id="form">
      <table width="900" border="0">
        ...
        <tr>
          <td colspan="4" class="heading">Edit Accomplishments</td>
          </tr>
        <tr>
          <td width="141" valign="top">&nbsp;</td>
          <td width="185" class="NormalRedSmall"><?=$err?>&nbsp;</td>
          <td width="200" class="linksPage"><a href="add_accomplishments.php">Add Accomplishments</a></td>
          <td width="356" class="linksPage">&nbsp;</td>
          </tr>
        <tr>
		...
		<tr>
		  ...
		  ?>
		 	<input name="rdo" id="show" type="radio" value="Show" <?php echo $show ?>>Show
            <input name="rdo" id="hide" type="radio" value="Hide" <?php echo $hide ?>>Hide
			</td>
		</tr>
        <tr>
