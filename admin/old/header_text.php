...
{
	case "":
		$sql = "select * from ".$tblAdmin." where autoid= 1";
	...
	case "Save":
		...
		" f_description = ".tosql($f_description,"Text").
  ...
  <tr>
    ...
    <form method="post" enctype="multipart/form-data" name="formp" id="formp">
      <table width="900" border="0">
        ...
        <tr>
          <td colspan="2" class="heading">Edit Header Text</td>
          </tr>
        <tr>
        ...
        <tr>
          <td valign="top" class="Normal">Header Text</td>
          <td valign="top"><?php
