...
{
	case "":
		$sql = "select * from ".$tblSubPages." where autoid= 5";
	...
	$tmp_name = $_FILES["uploadimage"]["tmp_name"];
		...
		if (!empty($tmp_name)) {			
			...
			$sql = "UPDATE ".$tblSubPages." SET image = '".$image."' where autoid =5";
  ...
  <tr>
    <td width="972" height="415" align="center" valign="top"><form method="post" enctype="multipart/form-data" name="form" id="form">
      <table width="900" border="0">
        ...
        <tr>
          <td colspan="4" class="heading">Edit Instructors</td>
          </tr>
        <tr>
          <td width="141" valign="top">&nbsp;</td>
          <td width="185" class="NormalRedSmall"><?=$err?>&nbsp;</td>
          <td width="200" class="linksPage"><a href="add_fulltime_instructors.php">Full time Instructors</a></td>
          <td width="356" class="linksPage"><a href="add_parttime_instructors.php">Part time Instructors</a></td>
          </tr>
        <tr>
          <td valign="top" class="Normal">Page Image</td>
          <td colspan="3" class="links"><input name="uploadimage" type="file" class="NormalTextBox" id="uploadimage">
        ...
        <tr>
          ...
          <td colspan="3"><input name="title" type="text" class="NormalTextBox" id="title" value="<?=$title?>" size="75"></td>
        </tr>
        <tr>
        ...
        <tr>
          <td>&nbsp;</td>
          <td colspan="3"><input name="Submit" type="submit" class="btn" id="Submit" value="Save"/></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td colspan="3"><img src="../assets/pages/<?=$image?>" width="745" height="238" /></td>
        </tr>
      </table>
    </form></td>
  </tr>
