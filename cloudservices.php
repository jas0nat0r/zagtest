...
$pageName = "Solutions";
$childpage = "Cloud Services";

  	$sqls = "select * from " . $tblServices . " WHERE id=9";
    $rss = mysql_query($sqls) or die(mysql_error());
    $rows = mysql_fetch_array($rss);
	
		$sqlc = "select * from " . $tblServices . " where id = 9 and status=1";
...
<div class="middlesection innerbackground fetchcontent">
    ...
    <div class="detailsleft">
    	<img src="images/pageservimg1.jpg" alt="detailimg"  class="solutionimage"/>
    </div>
