        ...
        <div class="dropshadow">  
            <div class="middlesection">
                ...
                <div class="homeboxes homemargine">
                    ...
                    <p><ul class="homeul">
                            <li class="auto-style1">Hyper-V</li>
                            <li class="auto-style1">VDI</li>
                            <li class="auto-style1">Remote Access</li>
                        </ul></p>
...
?>               
                        ...
                        <a href='news.php?newsid=<?php echo $rowNews['idnews']; ?>'>More news</a><br class='clear'/> <br class='clear'/>
...
<?php } ?>
                    ...
                    <div class="footernews footerawarsd">
                        <h2>Awards</h2>
                        <p>
						<img alt="homelogos" height="72" src="images/homelogos1.png" width="410">&nbsp;</p>
